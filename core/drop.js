...
function logDrop(mult){var chip=document.createElement("span");chip.className="drop-chip-dc6e06b3"+
...
function say(text,mood){noteEl.textContent=text;noteEl.classList.remove("drop-note-up","drop-note-down");if(mood==="up"){noteEl.classList.add("drop-note-up-dc6e06b3");}else if(mood==="down"){noteEl.classList.add("drop-note-down-dc6e06b3");}}
